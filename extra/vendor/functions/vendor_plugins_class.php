<?php
class vendor_plugins_class{
	public static function create_element($id, $stap, $plugins, $name = false){
		if($name == true){
...
TEXT;
	...
	public static function update_element($id, $stap, $plugins, $element){
...
TEXT;
	...
	public static function open_element($id, $stap, $plugins, $element){
		$element_name = $element['name'];
		$element_title = $element->title;
		$element_target = $element->target;
		$element_href = $element->href;
