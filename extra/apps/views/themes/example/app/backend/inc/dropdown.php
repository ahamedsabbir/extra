...
?>
						<button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton222" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" ondblclick="window.location='<?php echo BASE_URL.$one_href; ?>'"><i class="fa-solid fa-house"></i> <?php echo $one_name ?></button>
