   ...
   <div class="container">
    <div class="row">
      <div class="col-md-12 col-lg-12">
        <form class="needs-validation" action="<?php echo BASE_URL.'project/project_insert_function/project'; ?>" method="POST" enctype="multipart/form-data">
          <div class="row g-3">
            <?php echo number_input_function("sn", 1); ?>
            <?php echo text_input_function("name", "name"); ?>
            <?php echo text_input_function("title", "title"); ?>
            <?php echo textarea_input_function("desctiption"); ?>
            <?php echo text_input_function("link", "html://"); ?>
            <?php echo fileLoop_input_function("image"); ?>
           	<?php echo textarea_input_function("note", "note"); ?>
            <?php echo text_input_function("font_icon", "fa-solid fa-helicopter-symbol"); ?>
            <div class="input-group has-validation">
    			<span class='input-group-text'><label for="button">Button</label></span>
