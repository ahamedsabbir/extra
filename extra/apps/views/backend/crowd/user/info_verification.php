					...
					<div class="row">
						<div class="col-md-offset-3 col-md-6">
							<div class="form-container">
								<h3 class="title">User Info Verification <?php echo report_class::chack_report(); ?></h3>
								<form class="form-horizontal" role="form" action="<?php echo BASE_URL.'user_crowd_class/info_verification_function/sign-in/'; ?>" method="POST" enctype="multipart/form-data">
									...
									<div class="form-group">
										...
										<input type="password" class="form-control" placeholder="Password" name="old_pass">
									</div>
									<div class="form-group">
