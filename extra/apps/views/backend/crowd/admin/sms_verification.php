					...
					<div class="row">
						<div class="col-md-offset-3 col-md-6">
							<div class="form-container">
								<h3 class="title">Mobile Verification</h3>
								<form class="form-horizontal" role="form" action="<?php echo BASE_URL.'admin_crowd_class/sms_verification_function/by_code_reset/'; ?>" method="POST" enctype="multipart/form-data">
