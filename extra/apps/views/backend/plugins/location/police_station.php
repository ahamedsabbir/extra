                            ...
                            <div class="card-heading">	
                                <div class="btn-group py-3" role="group" aria-label="Button group with nested dropdown">
                                  <div class="btn-group" role="group">
                                    <h1 id="btnGroupDrop1" type="button" class="btn btn-lg active" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Police Station</h1>
                                  </div>
                                  <button onclick="window.location='<?php echo BACKEND_HOME; ?>'" type="button" class="btn btn-lg">Home</button>
                                  <button type="button" class="btn btn-lg" data-toggle="modal" data-target="#policeStationModal">view</button>
                                </div>
                            </div>
							 <div class="card-body">
								<form role="form" action="<?php echo BASE_URL.'plugins_location_class/police_station_insert_function/police_station'; ?>" method="POST" enctype="multipart/form-data">
<div class="form-row">
	<div class="name">District</div>
	<div class="value">
		<div class="input-group">
			<select class="input--style-6" name="district">
<?php
