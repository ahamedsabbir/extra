...
.menu_section > ul ul{list-style-type: none;}
 ...
 <?php
$page = "backend_menu";
$xml_file = "extra/apps/views/backend/assets/xml/menu.xml";
...
$backendMenu = <<<TEXT
<li class="nav-item">
  <a class="nav-link text-white" href="" data-bs-toggle="modal" data-bs-target="#createzero">Add Nav</a>
</li>
TEXT;
echo plugins_nav_class::create_element("createzero", "zero", $page, $array_key, $array_value);
...
?>
		...
		<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
		  <div class="container-fluid">
			<a class="navbar-brand" href="#"><?php echo $xml_folder; ?> Url = <?php echo $xml_file; ?></a>
		  </div>
		</nav>
	</header>
	<section class="py-3">
			...
			<div class="btn-group" role="group" aria-label="Button group with nested dropdown">
			  ...
			  <div class="btn-group" role="group">
				...
				<ul class="dropdown-menu" aria-labelledby="btnGroupDrop1">
					...
					<li><a class="dropdown-item" onclick="return confirm('Are you sure?')" href="<?php echo BASE_URL.'plugins_nav_class/delete_function/'.$page.'/'.$array_key.'/'.$array_value.'/&xml_folder='.$xml_folder.'&delete=zero&zero='.$zero_id; ?>">Delete</a></li>
				</ul>
					...
					<div class="btn-group" role="group" aria-label="Button group with nested dropdown">
					  ...
					  <div class="btn-group" role="group">
						...
						<ul class="dropdown-menu" aria-labelledby="btnGroupDrop1">
							...
							<li><a class="dropdown-item" onclick="return confirm('Are you sure?')" href="<?php echo BASE_URL.'plugins_nav_class/delete_function/'.$page.'/'.$array_key.'/'.$array_value.'/&xml_folder='.$xml_folder.'&delete=one&zero='.$zero_id.'&one='.$one_id; ?>">Delete</a></li>
						</ul>
					...
					<div class="btn-group" role="group" aria-label="Button group with nested dropdown">
					  ...
					  <div class="btn-group" role="group">
						...
						<ul class="dropdown-menu" aria-labelledby="btnGroupDrop1">
							...
							<li><a class="dropdown-item" onclick="return confirm('Are you sure?')" href="<?php echo BASE_URL.'plugins_nav_class/delete_function/'.$page.'/'.$array_key.'/'.$array_value.'/&xml_folder='.$xml_folder.'&delete=two&zero='.$zero_id.'&one='.$one_id.'&two='.$two_id; ?>">Delete</a></li>
						</ul>
							...
							<div class="btn-group" role="group" aria-label="Button group with nested dropdown">
							  ...
							  <div class="btn-group" role="group">
								...
								<ul class="dropdown-menu" aria-labelledby="btnGroupDrop1">
									...
									<li><a class="dropdown-item" onclick="return confirm('Are you sure?')" href="<?php echo BASE_URL.'plugins_nav_class/delete_function/'.$page.'/'.$array_key.'/'.$array_value.'/&xml_folder='.$xml_folder.'&delete=three&zero='.$zero_id.'&one='.$one_id.'&two='.$two_id.'&three='.$three_id; ?>">Delete</a></li>
								</ul>
									...
									<div class="btn-group" role="group" aria-label="Button group with nested dropdown">
									  ...
									  <div class="btn-group" role="group">
										...
										<ul class="dropdown-menu" aria-labelledby="btnGroupDrop1">
											...
											<li><a class="dropdown-item" onclick="return confirm('Are you sure?')" href="<?php echo BASE_URL.'plugins_nav_class/delete_function/'.$page.'/'.$array_key.'/'.$array_value.'/&xml_folder='.$xml_folder.'&delete=four&zero='.$zero_id.'&one='.$one_id.'&two='.$two_id.'&three='.$three_id.'&four='.$four_id; ?>">Delete</a></li>
										</ul>
