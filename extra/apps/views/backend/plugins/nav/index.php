...
?>
				...
				<li><a ondblclick="window.location='<?php echo BASE_URL.$two->href; ?>'" class="dropdown-item" href="<?php echo BASE_URL.$two->href; ?>"><?php echo $two["name"]; ?></a>
<?php
					if($two->three != false){
?>
...
?>			
	...
	<?php include(backend_class::inc("footer", $plugins)) ?>
</body>
</html>