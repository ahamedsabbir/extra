...
.menu_section > ul ul{list-style-type: none;}
 ...
 <?php
$page = "plugins_menu";
$xml_file = "extra/apps/views/backend/plugins/".$xml_folder."/assets/xml/nav.xml";
	...
	<header class="container">
		<nav class="navbar navbar-expand-lg navbar-light bg-light">
		  <div class="container-fluid">
			<a class="navbar-brand" href="#"><?php echo $xml_folder; ?> Menu</a>
		...
		<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
		  <div class="container-fluid">
			<a class="navbar-brand" href="#">Url = <?php echo $xml_file; ?></a>
		  </div>
		</nav>
	</header>
	<main class="py-3">
			...
			<div class="btn-group" role="group" aria-label="Button group with nested dropdown">
			  ...
			  <div class="btn-group" role="group">
				...
				<ul class="dropdown-menu" aria-labelledby="btnGroupDrop1">
					...
					<li><a class="dropdown-item" href="<?php echo BASE_URL.'plugins_nav_class/delete_function/'.$page.'/'.$array_key.'/'.$array_value.'/&xml_folder='.$xml_folder.'&delete=zero&zero='.$zero_id; ?>">Delete</a></li>
				</ul>
					...
					<div class="btn-group" role="group" aria-label="Button group with nested dropdown">
					  ...
					  <div class="btn-group" role="group">
						...
						<ul class="dropdown-menu" aria-labelledby="btnGroupDrop1">
							...
							<li><a class="dropdown-item" href="<?php echo BASE_URL.'plugins_nav_class/delete_function/'.$page.'/'.$array_key.'/'.$array_value.'/&xml_folder='.$xml_folder.'&delete=one&zero='.$zero_id.'&one='.$one_id; ?>">Delete</a></li>
						</ul>
					...
					<div class="btn-group" role="group" aria-label="Button group with nested dropdown">
					  ...
					  <div class="btn-group" role="group">
						...
						<ul class="dropdown-menu" aria-labelledby="btnGroupDrop1">
							...
							<li><a class="dropdown-item" href="<?php echo BASE_URL.'plugins_nav_class/delete_function/'.$page.'/'.$array_key.'/'.$array_value.'/&xml_folder='.$xml_folder.'&delete=two&zero='.$zero_id.'&one='.$one_id.'&two='.$two_id; ?>">Delete</a></li>
						</ul>
							...
							<div class="btn-group" role="group" aria-label="Button group with nested dropdown">
							  ...
							  <div class="btn-group" role="group">
								...
								<ul class="dropdown-menu" aria-labelledby="btnGroupDrop1">
									...
									<li><a class="dropdown-item" href="<?php echo BASE_URL.'plugins_nav_class/delete_function/'.$page.'/'.$array_key.'/'.$array_value.'/&xml_folder='.$xml_folder.'&delete=three&zero='.$zero_id.'&one='.$one_id.'&two='.$two_id.'&three='.$three_id; ?>">Delete</a></li>
								</ul>
									...
									<div class="btn-group" role="group" aria-label="Button group with nested dropdown">
									  ...
									  <div class="btn-group" role="group">
										...
										<ul class="dropdown-menu" aria-labelledby="btnGroupDrop1">
											...
											<li><a class="dropdown-item" href="<?php echo BASE_URL.'plugins_nav_class/delete_function/'.$page.'/'.$array_key.'/'.$array_value.'/&xml_folder='.$xml_folder.'&delete=four&zero='.$zero_id.'&one='.$one_id.'&two='.$two_id.'&three='.$three_id.'&four='.$four_id; ?>">Delete</a></li>
										</ul>
