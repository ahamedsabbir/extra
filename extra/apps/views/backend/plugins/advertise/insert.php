     ...
     <div class="container">
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
          <div class="container-fluid">
            <a class="navbar-brand" href="#">advertise</a>
   ...
   <div class="container">
    <div class="row">
      <div class="col-md-12 col-lg-12">
        <form class="needs-validation" action="<?php echo BASE_URL.'advertise/advertise_insert_function/insert'; ?>" method="POST" enctype="multipart/form-data">
          	<div class="row g-3">
            	<?php echo text_input_function("name", "advertise Name"); ?>
              	<?php echo text_input_function("title", "advertise Title"); ?>
            	<?php echo ckeditor_textarea_function("desctiption", "desctiption"); ?>
              	<?php echo text_input_function("link", "http://"); ?>
