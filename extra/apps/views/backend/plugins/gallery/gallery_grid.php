...
<head>
	...
	<?php echo backend_class::style("gallery_grid", $plugins_type, $plugins); ?>
...
<div class="container gallery-container">
    ...
    <div class="tz-gallery">
        ...
        <div class="row">
            ...
            <div class="col-sm-6 col-md-4">
                <a class="lightbox" href="<?php echo backend_class::source("assets/images/bridge.jpg", $plugins_type, $plugins); ?>">
                    <img src="<?php echo backend_class::source("assets/images/bridge.jpg", $plugins_type, $plugins); ?>" alt="Rocks">
                </a>
            </div>
            <div class="col-sm-6 col-md-4">
                <a class="lightbox" href="<?php echo backend_class::source("assets/images/bridge.jpg", $plugins_type, $plugins); ?>">
                    <img src="<?php echo backend_class::source("assets/images/bridge.jpg", $plugins_type, $plugins); ?>" alt="Benches">
                </a>
            </div>
            <div class="col-sm-6 col-md-4">
                <a class="lightbox" href="<?php echo backend_class::source("assets/images/bridge.jpg", $plugins_type, $plugins); ?>">
                    <img src="<?php echo backend_class::source("assets/images/bridge.jpg", $plugins_type, $plugins); ?>" alt="Sky">
                </a>
            </div>
        </div>
