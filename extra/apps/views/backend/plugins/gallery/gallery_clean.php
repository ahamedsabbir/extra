...
<?php echo backend_class::style("gallery_clean", $plugins_type, $plugins); ?>
    ...
    <div class="tz-gallery">
        ...
        <div class="row">
            ...
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    <a class="lightbox" href="<?php echo backend_class::source("assets/images/bridge.jpg", $plugins_type, $plugins); ?>">
                        <img src="<?php echo backend_class::source("assets/images/bridge.jpg", $plugins_type, $plugins); ?>" alt="Tuneel">
                    </a>
                    <div class="caption">
                        <h3>Thumbnail label</h3>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
