...
function add_function($unique_terget_id){
	...
	$link = BASE_URL."backend_brand_class/insert_brand_function/brand/";
	$models = <<<TEXT
...
function update_function($framework_brand_datatable_value){
	$id = $framework_brand_datatable_value['id'];
	$sn = $framework_brand_datatable_value['sn'];
	$datatable = $framework_brand_datatable_value['datatable'];
	$name = $framework_brand_datatable_value['name'];
	$title = $framework_brand_datatable_value['title'];
	$icon = $framework_brand_datatable_value['icon'];
	$font_icon = $framework_brand_datatable_value['font_icon'];
	$link = BASE_URL."backend_brand_class/update_brand_function/brand/&brand_id=".$id;
	$models = <<<TEXT
