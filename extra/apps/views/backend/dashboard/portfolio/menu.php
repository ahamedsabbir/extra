			  ...
			  <ul class="navbar-nav">
				...
				<li class="nav-item">
				  <a class="nav-link active" href="#" data-bs-toggle="modal" data-bs-target="#createelement">Add New</a>
					<?php echo vendor_plugins_class::create_element("createelement", "new", $plugins); ?>
				</li>
			  </ul>
			</div>
		  </div>
				  ...
				  <div class="card-body"> 
					<div class="btn-group" role="group" aria-label="Button group with nested dropdown">
					  ...
					  <div class="btn-group" role="group">
						...
						<?php echo vendor_plugins_class::create_element("create".$one["name"], "one", $plugins, $one["name"]); ?>
						<?php echo vendor_plugins_class::update_element("update".$one["name"], "one", $plugins, $one); ?>
						<?php echo vendor_plugins_class::open_element("open".$one["name"], "one", $plugins, $one); ?>
					  </div>
					</div>
				<ul>
				...
				<li class="py-1">
					<div class="btn-group" role="group" aria-label="Button group with nested dropdown">
					  ...
					  <div class="btn-group" role="group">
						...
						<?php echo vendor_plugins_class::create_element("create".$two["name"], "two", $plugins, $two["name"]); ?>
						<?php echo vendor_plugins_class::update_element("update".$two["name"], "two", $plugins, $two); ?>
						<?php echo vendor_plugins_class::open_element("open".$two["name"], "two", $plugins, $two); ?>
					  </div>
					</div>
					<ul class="">
<?php
						...
						<li class="py-1">
							<div class="btn-group" role="group" aria-label="Button group with nested dropdown">
							  ...
							  <div class="btn-group" role="group">
								...
								<?php echo vendor_plugins_class::create_element("create".$three["name"], "three", $plugins, $three["name"]); ?>
								<?php echo vendor_plugins_class::update_element("update".$three["name"], "three", $plugins, $three); ?>
								<?php echo vendor_plugins_class::open_element("open".$three["name"], "three", $plugins, $three); ?>
							  </div>
							</div>
							<ul class="">
<?php
								...
								<li class="py-1">
									<div class="btn-group" role="group" aria-label="Button group with nested dropdown">
									  ...
									  <div class="btn-group" role="group">
										...
										<?php echo vendor_plugins_class::update_element("update".$four["name"], "four", $plugins, $four); ?>
										<?php echo vendor_plugins_class::open_element("open".$four["name"], "four", $plugins, $four); ?>
									  </div>
									</div>
								</li>
<?php
