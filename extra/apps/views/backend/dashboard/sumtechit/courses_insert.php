   ...
   <div class="container">
    <div class="row">
      <div class="col-md-12 col-lg-12">
        <form class="needs-validation" action="<?php echo BASE_URL.'dashboard_sumtechit/courses_insert_function/courses_loop'; ?>" method="POST" enctype="multipart/form-data">
          <div class="row g-3" id="">
            <?php echo text_input_function("name", "name"); ?>
            <?php echo text_input_function("heading", "heading"); ?>
			<div class="col-md-12">
			...
			<div class="col-md-12">
              <div class="input-group has-validation">
    			<span class='input-group-text'><label for="$country">Category</label></span>
                <select class="form-select" id="country" name="category">
					<option>Select</option>
					<?php select_option_loop($framework_category_datatable); ?>
                </select>
              </div>
            </div>
			<?php echo text_input_function("title", "post title writein here."); ?>
			<?php echo textarea_input_function("description", "description title writein here."); ?>
			<?php echo textarea_input_function("details", "details title writein here."); ?>
			<?php echo ckeditor_textarea_function("facilities", "details facilities writein here."); ?>
			<?php echo number_input_function("old_price", 1); ?>
			<?php echo number_input_function("new_price", 1); ?>
			<?php echo newFile_input_function("img"); ?>
