...
?>
					<li class='mt-2'>
                      	<button class='btn btn-danger btn-lg' onclick="window.location='<?php echo BASE_URL.$one_href; ?>'" ><?php echo $one_name ?></button>
...
?>
		<li class='mt-2'>
			<button class='btn btn-primary btn-lg' onclick="window.location='<?php echo BASE_URL.$two_href; ?>'" ><?php echo $two_name ?></button>
			<ul class="list-unstyled ms-4">
<?php
...
?>
									<li class='mt-2'>
										<button class='btn btn-secondary btn-lg' onclick="window.location='<?php echo BASE_URL.$three_href; ?>'" ><?php echo $three_name ?></button>
										<ul class="list-unstyled ms-4">
<?php											
...
?>
									<li class="mt-2">
										<button class='btn btn-success btn-lg' onclick="window.location='<?php echo BASE_URL.$four_href; ?>'"><?php echo $four_name ?></button>
									</li>
<?php
								}else{}
							}//four for
