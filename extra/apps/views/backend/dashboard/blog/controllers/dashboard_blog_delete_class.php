<?php
class dashboard_blog_delete_class extends backend_controller_class{
	...
	public function index_page_function($page, $array_key = false, $array_value = false){
		header(address_class::header_page("dashboard_blog_author_class", "index_page_function", $page));
	}
