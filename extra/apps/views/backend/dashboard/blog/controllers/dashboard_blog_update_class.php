<?php
class dashboard_blog_update_class extends backend_controller_class{
	public $plugins;
	public $plugins_type;
		...
		if(isset($_POST["submit"]) AND $_POST["submit"] == "update"){
			...
			if($this->get_data_array[$this->primary_datatable] != null){
				...
				if($this->method_array['text_validation_class']->submit() AND $this->method_array['file_validation_class']->submit()){
					...
					if($update == true){
						header("location:".BASE_URL."dashboard_blog_update_class/index_page_function/$page/&post_id=$post_id");
					}else{
