   ...
   <div class="container">
    <div class="row">
      <div class="col-md-12 col-lg-12">
        <form class="needs-validation" action="<?php echo BASE_URL.'dashboard_redweb_insert_class/post_insert_function/loop/'; ?>" method="POST" enctype="multipart/form-data">
          <div class="row g-3" id="layerTwoadd">
            <?php echo text_input_function("title", "post title"); ?>
            <?php echo text_input_function("keywords", "keywords"); ?>
            <?php echo textarea_input_function("description"); ?>
            <div class="col-md-12">
...
?>
            ...
            <?php echo text_input_function("source", "post title"); ?>
