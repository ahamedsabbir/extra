                            ...
                            <div class="card-heading">	
                                <div class="btn-group py-3" role="group" aria-label="Button group with nested dropdown">
                                  <div class="btn-group" role="group">
                                    <h1 id="btnGroupDrop1" type="button" class="btn btn-lg active" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Interior</h1>
                                  </div>
							 ...
							 <div class="card-body">
								<form role="form" action="<?php echo BASE_URL.'dashboard_interior/image_submit_function/image_post'; ?>" method="POST" enctype="multipart/form-data">
									<?php echo text_input("title", "intorior title"); ?>
                                  	<?php echo category_select($framework_category_datatable, "category"); ?>
                                  	<?php echo file_input("image"); ?>
