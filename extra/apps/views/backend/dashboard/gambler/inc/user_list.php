<a class="navbar-brand" style="-left:34px;" href="#" onclick="openNotification()">
...
<section id="rightsidenotification" class="rightsidenotification">
  ...
  <div class="flex-shrink-0 p-3 bg-white">
	...
	<form class="d-flex me-3" role="form" action="<?php echo BASE_URL.'theme_redweb_search_class/index_page_function/loop/'; ?>" method="POST" enctype="multipart/form-data">
...
?>
<li><button onclick="window.location='index.php?url=plugins_chat_class/index_page_function/vchat/'" type="button" class="btn btn-danger">visitor</button></li>
</ul>
</section>
<script>
