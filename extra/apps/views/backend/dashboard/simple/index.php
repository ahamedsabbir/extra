...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="extra/apps/views/backend/dashboard/simple/assets/images/favicon.png">
	<link rel="stylesheet" href="extra/apps/views/backend/dashboard/simple/assets/vendor/chartist/extra/apps/views/backend/dashboard/simple/assets/style/chartist.min.css">
    <link href="extra/apps/views/backend/dashboard/simple/assets/vendor/bootstrap-select/dist/extra/apps/views/backend/dashboard/simple/assets/style/bootstrap-select.min.css" rel="stylesheet">
	<link href="extra/apps/views/backend/dashboard/simple/assets/vendor/owl-carousel/owl.carousel.css" rel="stylesheet">
    <link href="extra/apps/views/backend/dashboard/simple/assets/style/style.css" rel="stylesheet">
...
<body>
    ...
    <div id="main-wrapper">
								...
								<ul class="contacts">
									...
									<li class="active dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="extra/apps/views/backend/dashboard/simple/assets/images/avatar/1.jpg" class="rounded-circle user_img" alt="">
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="extra/apps/views/backend/dashboard/simple/assets/images/avatar/2.jpg" class="rounded-circle user_img" alt="">
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="extra/apps/views/backend/dashboard/simple/assets/images/avatar/3.jpg" class="rounded-circle user_img" alt="">
												<span class="online_icon"></span>
											</div>
											<div class="user_info">
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="extra/apps/views/backend/dashboard/simple/assets/images/avatar/4.jpg" class="rounded-circle user_img" alt="">
												<span class="online_icon offline"></span>
											</div>
											<div class="user_info">
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="extra/apps/views/backend/dashboard/simple/assets/images/avatar/5.jpg" class="rounded-circle user_img" alt="">
												<span class="online_icon offline"></span>
											</div>
											<div class="user_info">
							...
							<div class="card-body msg_card_body dz-scroll" id="DZ_W_Contacts_Body3">
								<div class="d-flex justify-content-start mb-4">
									<div class="img_cont_msg">
										<img src="extra/apps/views/backend/dashboard/simple/assets/images/avatar/1.jpg" class="rounded-circle user_img_msg" alt="">
									</div>
								...
								<div class="d-flex justify-content-end mb-4">
									...
									<div class="img_cont_msg">
								<img src="extra/apps/views/backend/dashboard/simple/assets/images/avatar/2.jpg" class="rounded-circle user_img_msg" alt="">
									</div>
								</div>
								<div class="d-flex justify-content-start mb-4">
									<div class="img_cont_msg">
                        ...
                        <ul class="navbar-nav header-right main-notification">
											...
											<li>
												<div class="timeline-panel">
													<div class="media mr-2">
														<img alt="image" width="50" src="extra/apps/views/backend/dashboard/simple/assets/images/avatar/1.jpg">
													</div>
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="#" role="button" data-toggle="dropdown">
                                    <img src="extra/apps/views/backend/dashboard/simple/assets/images/profile/pic1.jpg" width="20" alt="">
        ...
        <div class="deznav">
            <div class="deznav-scroll">
				<div class="main-profile">
					<div class="image-bx">
						<img src="extra/apps/views/backend/dashboard/simple/assets/images/Untitled-1.jpg" alt="">
        ...
        ***********************************-->
        <div class="content-body">
			<!-- <div class="form-head" style="background-image:url('extra/apps/views/backend/dashboard/simple/assets/images/background/bg3.jpg');background-position: bottom; ">
						...
						<div class="row">
							<div class="col-sm-6">
								<div class="card-bx stacked card">
									<img src="extra/apps/views/backend/dashboard/simple/assets/images/card/card1.jpg" alt="">
									<div class="card-info">
							...
							<div class="col-sm-6">
								<div class="card-bx stacked card">
									<img src="extra/apps/views/backend/dashboard/simple/assets/images/card/card2.jpg" alt="">
									<div class="card-info">
							...
							<div class="col-sm-6">
								<div class="card-bx stacked card">
									<img src="extra/apps/views/backend/dashboard/simple/assets/images/card/card3.jpg" alt="">
									<div class="card-info">
										<p class="mb-1 text-white fs-14">Main Balance</p>
										<div class="d-flex justify-content-between">
											<h2 class="num-text text-white mb-5 font-w600">$673,412.66</h2>
							...
							<div class="col-sm-6">
								<div class="card-bx stacked card">
									<img src="extra/apps/views/backend/dashboard/simple/assets/images/card/card4.jpg" alt="">
									<div class="card-info">
										<p class="mb-1 text-white fs-14">Main Balance</p>
										<div class="d-flex justify-content-between">
											<h2 class="num-text text-white mb-5 font-w600">$673,412.66</h2>
										...
										<div class="testimonial-one px-4 owl-right-nav owl-carousel owl-loaded owl-drag">
											<div class="items">
												<div class="text-center">
													<img class="mb-3 rounded" src="extra/apps/views/backend/dashboard/simple/assets/images/contacts/Untitled-1.jpg" alt="">
											...
											<div class="items">
												<div class="text-center">
													<img class="mb-3 rounded" src="extra/apps/views/backend/dashboard/simple/assets/images/contacts/Untitled-2.jpg" alt="">
											...
											<div class="items">
												<div class="text-center">
													<img class="mb-3 rounded" src="extra/apps/views/backend/dashboard/simple/assets/images/contacts/Untitled-3.jpg" alt="">
											...
											<div class="items">
												<div class="text-center">
													<img class="mb-3 rounded" src="extra/apps/views/backend/dashboard/simple/assets/images/contacts/Untitled-4.jpg" alt="">
											...
											<div class="items">
												<div class="text-center">
													<img class="mb-3 rounded" src="extra/apps/views/backend/dashboard/simple/assets/images/contacts/Untitled-5.jpg" alt="">
    ...
    ***********************************-->
    <!-- Required vendors -->
    <script data-cfasync="false" src="../cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script src="extra/apps/views/backend/dashboard/simple/assets/vendor/global/global.min.js"></script>
	<script src="extra/apps/views/backend/dashboard/simple/assets/vendor/bootstrap-select/dist/extra/apps/views/backend/dashboard/simple/assets/script/bootstrap-select.min.js"></script>
	<script src="extra/apps/views/backend/dashboard/simple/assets/vendor/chart.extra/apps/views/backend/dashboard/simple/assets/script/Chart.bundle.min.js"></script>
	
	<!-- Chart piety plugin files -->
    <script src="extra/apps/views/backend/dashboard/simple/assets/vendor/peity/jquery.peity.min.js"></script>
	
	<!-- Apex Chart -->
	<script src="extra/apps/views/backend/dashboard/simple/assets/vendor/apexchart/apexchart.js"></script>
	
	<!-- Dashboard 1 -->
	<script src="extra/apps/views/backend/dashboard/simple/assets/script/dashboard/dashboard-1.js"></script>
	
	<script src="extra/apps/views/backend/dashboard/simple/assets/vendor/owl-carousel/owl.carousel.js"></script>
    <script src="extra/apps/views/backend/dashboard/simple/assets/script/custom.min.js"></script>
	<script src="extra/apps/views/backend/dashboard/simple/assets/script/deznav-init.js"></script>
    <script src="extra/apps/views/backend/dashboard/simple/assets/script/demo.js"></script>
    <script src="extra/apps/views/backend/dashboard/simple/assets/script/styleSwitcher.js"></script>
