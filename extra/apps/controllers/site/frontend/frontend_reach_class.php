<?php
class frontend_reach_class extends frontend_controller_class{
	...
	public function like_submit_function($page, $array_key = false, $array_value = false){
		...
		$set_reach_array = array( 
			"total_like" => $this->model_array["count_db_class"]->count_db_function($this->primary_datatable, array("post_id" => $post_id, "status" => 1)),
			"total_unlike" => $this->model_array["count_db_class"]->count_db_function($this->primary_datatable, array("post_id" => $post_id, "status" => 0))
