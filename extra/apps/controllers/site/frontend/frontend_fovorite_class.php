<?php
class theme_redweb_favorite_class extends frontend_redweb_controller_class{
	public function __construct(){
		lock_class::lock_function(false);
		cookie_class::cookie_check("user_crowd_class", "index_page_function", "sign-out");
		parent::__construct();
		$this->get_data_array["primary_datatable"] = $this->primary_datatable = "framework_favorite_datatable";
	}
	...
	public function favorite_add_function($page, $array_key = false, $array_value = false){
	...
	public function favorites_delete_function($page, $array_key = false, $array_value = false){
		$post_id = parent::data_control("post_id");
