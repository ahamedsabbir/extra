...
class post_loop_class extends frontend_sumtech_controller_class{
	...
	public function index_page_function($page, $array_key = false, $array_value = false){
		...
		$this->get_data_array["shop_datatable"] = $this->model_array["pagenation_db_class"]->pagenation_select_db_function("shop_datatable", array("status" => 1), "ID DESC", $this->pageno, vendor_pagenation_class::$loop_item);
