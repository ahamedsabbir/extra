 ...
 * @method \Aws\Result cancelDataresourcesTask(array $args = [])
 * @method \GuzzleHttp\Promise\Promise cancelDataresourcesTaskAsync(array $args = [])
 ...
 * @method \Aws\Result createDataresourcesAssociation(array $args = [])
 * @method \GuzzleHttp\Promise\Promise createDataresourcesAssociationAsync(array $args = [])
 * @method \Aws\Result createDataresourcesTask(array $args = [])
 * @method \GuzzleHttp\Promise\Promise createDataresourcesTaskAsync(array $args = [])
 ...
 * @method \Aws\Result deleteDataresourcesAssociation(array $args = [])
 * @method \GuzzleHttp\Promise\Promise deleteDataresourcesAssociationAsync(array $args = [])
 ...
 * @method \Aws\Result describeDataresourcesAssociations(array $args = [])
 * @method \GuzzleHttp\Promise\Promise describeDataresourcesAssociationsAsync(array $args = [])
 * @method \Aws\Result describeDataresourcesTasks(array $args = [])
 * @method \GuzzleHttp\Promise\Promise describeDataresourcesTasksAsync(array $args = [])
 ...
 * @method \Aws\Result updateDataresourcesAssociation(array $args = [])
 * @method \GuzzleHttp\Promise\Promise updateDataresourcesAssociationAsync(array $args = [])
