...
class ImageEdit extends CommandAbstract
{
    ...
    public function execute(Request $request, WorkingFolder $workingFolder, EventDispatcher $dispatcher, Acl $acl, ResizedImageresources $resizedImageresources, Thumbnailresources $thumbnailresources, Config $config)
    {
