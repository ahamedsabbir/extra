...
class ResizedImage extends ResizedImageAbstract
{
    ...
    /**
     * @param ResizedImageresources $resizedImageresources Resized image resources object
     ...
     */
    public function __construct(ResizedImageresources $resizedImageresources, ResourceType $sourceFileResourceType, $sourceFileDir, $sourceFileName, $requestedWidth, $requestedHeight, $forceRequestedSize = false)
    {
        ...
        $app = $this->resizedImageresources->getContainer();
