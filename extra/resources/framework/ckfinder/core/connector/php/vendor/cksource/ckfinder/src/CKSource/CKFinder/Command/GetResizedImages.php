...
class GetResizedImages extends CommandAbstract
{
    ...
    public function execute(Request $request, WorkingFolder $workingFolder, ResizedImageresources $resizedImageresources, Config $config, CacheManager $cache)
    {
        ...
        $resizedImages = $resizedImageresources->getResizedImagesList(
