<?php
namespace Aws\ServerlessApplicationresources;

use Aws\AwsClient;

/**
 * This client is used to interact with the **AWSServerlessApplicationresources** service.
 ...
 */
class ServerlessApplicationresourcesClient extends AwsClient {}
