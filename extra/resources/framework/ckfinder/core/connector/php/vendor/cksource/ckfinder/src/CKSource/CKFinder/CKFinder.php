...
class CKFinder extends Container implements HttpKernelInterface
{
    ...
    public function __construct($config)
    {
        ...
        $this['thumbnail_resources'] = function () use ($app) {
            return new Thumbnailresources($app);
        };

        $this['resized_image_resources'] = function () use ($app) {
            return new ResizedImageresources($app);
        };
    ...
    /**
     * Returns the resized image resources.
     *
     * @return ResizedImageresources
     */
    public function getResizedImageresources()
    {
        return $this['resized_image_resources'];
    }
