...
class ImageResize extends CommandAbstract
{
    ...
    public function execute(Request $request, WorkingFolder $workingFolder, Config $config, ResizedImageresources $resizedImageresources)
    {
        ...
        $resizedImage = $resizedImageresources->getResizedImage(
