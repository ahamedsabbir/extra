...
class WorkingFolder extends Folder implements EventSubscriberInterface
{
    ...
    /**
     * Returns the thumbnails resources object.
     *
     * @return Thumbnailresources
     */
    public function getThumbnailsresources()
    {
    ...
    public function delete()
    {
        ...
        $this->thumbnailresources->deleteThumbnails($this->resourceType, $this->getClientCurrentFolder());
    ...
    {
        return $this->app['resized_image_resources'];
    }
