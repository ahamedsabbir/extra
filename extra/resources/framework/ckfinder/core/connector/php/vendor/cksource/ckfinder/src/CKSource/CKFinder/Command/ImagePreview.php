...
class ImagePreview extends CommandAbstract
{
    ...
    public function execute(Request $request, Config $config, WorkingFolder $workingFolder, ResizedImageresources $resizedImageresources, CacheManager $cache)
    {
        ...
        if ($cachedInfo && isset($cachedInfo['width'], $cachedInfo['height'])) {
            ...
            $resizedImage = $resizedImageresources->getResizedImageBySize(
