...
class Thumbnail extends CommandAbstract
{
    ...
    public function execute(Request $request, WorkingFolder $workingFolder, Config $config, Thumbnailresources $thumbnailresources)
    {
        ...
        if (!Image::isSupportedExtension($ext, $thumbnailresources->isBitmapSupportEnabled())) {
        ...
        $thumbnail = $thumbnailresources->getThumbnail(
