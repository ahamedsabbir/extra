<?php
class XMLDP_controller_class extends main_soft_controller_class{
  	public $xml;
  	public $theme_folder;
  	public $theme_url;
  	public $content;
	...
	public function __construct(){  
      	$this->theme_name = $this->get_data_array["theme_name"] = "XMLDP";
      	$this->post_datatable = $this->get_data_array["post_datatable"] = "XMLDP_datatable";
      	parent::__construct();
		...
		$this->xml = $this->get_data_array['xml'] = "extra/resources/xml/xmldb.xml";
