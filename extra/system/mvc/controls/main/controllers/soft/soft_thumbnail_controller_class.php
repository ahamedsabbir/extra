<?php
class soft_thumbnail_controller_class extends main_soft_controller_class{
  	public $xml;
  	public $soft_folder;
  	public $soft_url;
  	public $content;
	...
	public function __construct(){  
      	$this->soft_name = $this->get_data_array["soft_name"] = "thumbnail";
      	$this->post_datatable = $this->get_data_array["post_datatable"] = "thumbnail_datatable";
      	parent::__construct();
