<?php
class soft_videodown_controller_class extends main_soft_controller_class{
  	public $xml;
  	public $soft_folder;
  	public $soft_url;
  	public $content;
	...
	public function __construct(){  
      	$this->soft_name = $this->get_data_array["soft_name"] = "videodown";
      	$this->post_datatable = $this->get_data_array["post_datatable"] = "videodown_datatable";
      	parent::__construct();
