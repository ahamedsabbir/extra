<?php
class frontend_rubi_controller_class extends main_theme_controller_class{
  	public $xml;
  	public $theme_folder;
  	public $theme_url;
  	public $content;
	...
	public function __construct(){ 	
      	$this->theme_name = $this->get_data_array["theme_name"] = "rubi";
      	$this->post_datatable = $this->get_data_array["post_datatable"] = "rubi_datatable";
      	parent::__construct();
