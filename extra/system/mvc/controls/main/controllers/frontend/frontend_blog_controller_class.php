<?php
class frontend_blog_controller_class extends main_index_controller_class{
  	public $xml;
  	public $theme_folder;
  	public $theme_url;
  	public $content;
	...
	public function __construct(){  
      	$this->theme_name = $this->get_data_array["theme_name"] = "blog";
      	$this->post_datatable = $this->get_data_array["post_datatable"] = "blog_datatable";
      	parent::__construct();
