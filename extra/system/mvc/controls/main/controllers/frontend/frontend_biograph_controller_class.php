<?php
class frontend_biograph_controller_class extends main_index_controller_class{
  	public $xml;
  	public $theme_folder;
  	public $theme_url;
  	public $content;
	...
	public function __construct(){  
      	$this->theme_name = $this->get_data_array["theme_name"] = "biograph";
      	$this->post_datatable = $this->get_data_array["post_datatable"] = "biograph_datatable";
      	parent::__construct();
